...
import { EmployeefamliydetailDetailComponent } from '../employeefamliydetail-detail/employeefamliydetail-detail.component';
@Component({
...
export class EmployeefamilydetailListComponent {
  displayedColumns: string[] = ['employeeId', 'firstName','middleName', 'lastName', 'dob', 'relationId','action'];
...
//  dob=new Date(1990,0,1);
 ...
 // public loaderservive:LoaderService,
  ...
  openemployeefamilydetail(){
    // debugger
    const dialogRef = this.dialog.open(EmployeefamliydetailDetailComponent);
